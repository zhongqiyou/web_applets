...
<table v-if="treeData.name">
    ...
    <td :colspan="Array.isArray(treeData.children) ? treeData.children.length * 2 : 1" :class="{parentLevel: Array.isArray(treeData.children) && treeData.children.length, extend: Array.isArray(treeData.children) && treeData.children.length && treeData.extend}">
      <div :class="{node: true, hasMate: treeData.mate}">
        ...
        <template v-if="treeData.mate">
          <div class="person" @click="$emit('click-node', treeData.mate)">
            <div class="avat">
  ...
  <tr v-if="Array.isArray(treeData.children) && treeData.children.length && treeData.extend">
    <template v-for="(children,index) in treeData.children">
      <td v-if="children.name" colspan="2" class="childLevel" :key="index">
