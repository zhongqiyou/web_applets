<template>
  <div>
    ...
    <el-dialog
      ...
      width="60%"
      >
      <userInfo audit="1" :user-id="userId"></userInfo>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="updateData = false">修 改</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
<script>
  import {auditList, deletedUser, updateUserAudit} from "../../api/user";
